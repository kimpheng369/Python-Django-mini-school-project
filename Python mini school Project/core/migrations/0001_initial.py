    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('EMPLOYEE', 'Employee'), ('INSTRUCTOR', 'Instructor'), ('STUDENT', 'Student')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.FloatField(blank=True, help_text='Grade in percentage, e.g., 85.5', null=True)),
